...
public class CaptchaModel {
    ...
    /**
     * Можно ли перекрашивать капчу в цвета установленной темы оформления
     */
    public boolean adaptable = true;
    /**
     * Режим «проезд оплачен»: капча уже разрешена (адаптивная.cookie валидна).
     * Изображение отображается, но поле ввода отключено и содержит текст «проезд оплачен».
     */
