...
public class ZeroFourBoards {
    private static final String[] ATTACHMENT_FILTERS = new String[] { "jpg", "jpeg", "png", "gif", "webp", "webm", "mp4", "jfif" };
    private static final String[] ATTACHMENT_FILTERS_NO_VIDEO = new String[] { "jpg", "jpeg", "png", "gif", "webp", "jfif" };
